...
- Botond Sipos, Greg Slodkowicz, Adrian M. Stütz, Tim Massingham, Jan Korbel, Nick Goldman: *PAT-seq - high-throughput poly(A) tail length determination assay for the Illumina platform*.
